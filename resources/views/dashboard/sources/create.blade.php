        ...
        <div class="card-body">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="code" class="form-control" value="{{ old('code') }}"
                            placeholder="مثال: خ، م، د" maxlength="10">
                        <small class="form-text text-muted">رمز مختصر للمصدر (اختياري)</small>
                    </div>
                </div>
                <div class="col-md-9">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control" value="{{ old('name') }}"
                            placeholder="مثال: صحيح البخاري، مكايد الشيطان" required>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="author" class="form-control" value="{{ old('author') }}"
                            placeholder="مثال: ابن أبي الدنيا">
                        <small class="form-text text-muted">يُعرض كالتالي: أخرجه [المؤلف] في [اسم المصدر]</small>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <select name="type" class="form-control">
                    ...
                    <option value="كتب المسانيد" {{ old('type') === 'كتب المسانيد' ? 'selected' : '' }}>كتب المسانيد
                    </option>
            ...
            <div class="alert alert-info">
                ...
                <strong>ملاحظة:</strong> الرمز اختياري — إن وُجد يجب أن يكون فريداً ويُستخدم في الاستخراج التلقائي
            </div>
        </div>
