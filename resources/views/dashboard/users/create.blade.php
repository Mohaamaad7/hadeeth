    ...
    <div class="card card-primary">
        ...
        <div class="card-body">
            <div class="form-group">
                ...
                <input type="text" name="name" class="form-control" value="{{ old('name') }}" placeholder="الاسم الكامل"
                    required>
            </div>
            ...
            <div class="form-group">
                ...
                <select name="role" class="form-control" required>
                    ...
                    <option value="reviewer" {{ old('role') === 'reviewer' ? 'selected' : '' }}>مراجع</option>
                    <option value="admin" {{ old('role') === 'admin' ? 'selected' : '' }}>مدير النظام</option>
                </select>
                <small class="form-text text-muted">
                    <strong>مدخل بيانات:</strong> يمكنه إدخال أحاديث فقط &bull;
                    <strong>مراجع:</strong> يمكنه مراجعة واعتماد الأحاديث &bull;
                    <strong>مدير النظام:</strong> كل الصلاحيات
                </small>
            </div>
        </div>
