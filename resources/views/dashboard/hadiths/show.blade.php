...
<div class="row">
    ...
    ($hadith->grade === 'حسن' ? 'info' :
        ...
        <div class="card card-danger">
            ...
            <div class="card-body">
                <a href="{{ route('dashboard.hadiths.edit', $hadith) }}" class="btn btn-warning btn-block">
                ...
                <a href="{{ route('dashboard.hadiths.index') }}" class="btn btn-secondary btn-block">
                    <i class="fas fa-list"></i> العودة للقائمة
                </a>
            </div>
        </div>

        <form id="delete-form" action="{{ route('dashboard.hadiths.destroy', $hadith) }}" method="POST"
            style="display: none;">
            @csrf
            @method('DELETE')
        </form>
