...
<div class="row">
    ...
    ($hadith->grade === 'حسن' ? 'info' :
        ...
        <?php if($hadith->explanation): ?>
            ...
            <div class="card card-info card-outline">
                ...
                <div class="card-body">
                    <div style="line-height: 1.8;"><?php echo $hadith->explanation; ?></div>
                </div>
            </div>
        <?php endif; ?>
    </div>
    ...
    ($hadith->grade === 'حسن' ? 'info' :
        ...
        <div class="card card-danger">
            ...
            <div class="card-body">
                <a href="<?php echo e(route('dashboard.hadiths.edit', $hadith)); ?>" class="btn btn-warning btn-block">
                ...
                <a href="<?php echo e(route('dashboard.hadiths.index')); ?>" class="btn btn-secondary btn-block">
                    <i class="fas fa-list"></i> العودة للقائمة
                </a>
            </div>
        </div>

        <form id="delete-form" action="<?php echo e(route('dashboard.hadiths.destroy', $hadith)); ?>" method="POST"
            style="display: none;">
            <?php echo csrf_field(); ?>
