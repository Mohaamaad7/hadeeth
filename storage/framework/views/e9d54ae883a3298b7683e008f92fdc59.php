<?php $__env->startSection('title', request('q') ? 'بحث: ' . request('q') . ' - موسوعة الحديث الصحيح' : 'البحث في الأحاديث - موسوعة الحديث الصحيح'); ?>
<?php $__env->startSection('meta_description', request('q') ? 'نتائج البحث عن "' . request('q') . '" في موسوعة الحديث الصحيح' : 'ابحث في آلاف الأحاديث الصحيحة في موسوعة الحديث الصحيح'); ?>
            ...
            <article class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:border-emerald-300 hover:shadow-lg transition-all animate-up" style="animation-delay: <?php echo e(($index + 2) * 0.05); ?>s;">
                <div class="p-6">
                    ...
                    <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                        ...
                        <a href="<?php echo e(route('hadith.show', [$hadith->id, $hadith->slug])); ?>" class="text-emerald-600 hover:text-emerald-700 font-bold text-sm transition-colors">
