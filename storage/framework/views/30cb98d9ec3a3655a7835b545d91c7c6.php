                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="raw_text" id="rawText" class="form-control" rows="4"
                            placeholder="مثال: [436] (صحيح) (د ت ن) عن أبي هريرة: قال رسول الله ﷺ..."><?php echo e(old('raw_text')); ?></textarea>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="explanation" class="form-control summernote" rows="3"
                            placeholder="أضف شرحاً أو تفسيراً للحديث..."><?php echo e(old('explanation')); ?></textarea>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="number_in_book" id="numberInBook" class="form-control"
                                    value="<?php echo e(old('number_in_book')); ?>" required min="1">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input source-checkbox"
                                            id="source_<?php echo e($source->id); ?>" name="source_ids[]" value="<?php echo e($source->id); ?>" <?php echo e(is_array(old('source_ids')) && in_array($source->id, old('source_ids')) ? 'checked' : ''); ?>>
