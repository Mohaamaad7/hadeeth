                ...
                <div>
                    ...
                    <div
                        ...
                        <input type="email" id="email" name="email" value="<?php echo e(old('email')); ?>" required
                            ...
                            class="block w-full pr-10 pl-3 py-3 rounded-lg focus:outline-none bg-transparent <?php $__errorArgs = ['email'];
...
unset($__errorArgs, $__bag); ?>"
            ...
            <div class="mt-8 text-center">
                <a href="<?php echo e(route('home')); ?>" class="text-sm text-gray-500 hover:text-emerald-600 transition-colors">
...
</html><?php /**PATH C:\laragon\www\hadeeth\resources\views/auth/login.blade.php ENDPATH**/ ?>