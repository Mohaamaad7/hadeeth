...
<head>
    ...
    <link rel="alternate" hreflang="ar" href="<?php echo $__env->yieldContent('canonical_url', url()->current()); ?>">
    <link rel="alternate" hreflang="x-default" href="<?php echo $__env->yieldContent('canonical_url', url()->current()); ?>">
    ...
    <meta property="og:image" content="<?php echo $__env->yieldContent('og_image', asset('og-image.png')); ?>">
    ...
    <meta name="twitter:image" content="<?php echo $__env->yieldContent('twitter_image', asset('og-image.png')); ?>">
...
</html><?php /**PATH C:\laragon\www\hadeeth\resources\views/layouts/frontend.blade.php ENDPATH**/ ?>