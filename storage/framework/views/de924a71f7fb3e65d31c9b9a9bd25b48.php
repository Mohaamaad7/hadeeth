...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <form id="delete-form" action="<?php echo e(route('dashboard.sources.destroy', $source)); ?>" 
            ...
            <div class="card card-success">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="<?php echo e(route('dashboard.hadiths.create')); ?>" 
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if($hadith->narrator): ?>
                                                <small class="text-muted"><?php echo e(Str::limit($hadith->narrator->name, 20)); ?></small>
                                            <?php else: ?>
