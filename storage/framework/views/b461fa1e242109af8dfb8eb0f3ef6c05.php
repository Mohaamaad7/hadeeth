<?php $__env->startSection('title', 'موسوعة الحديث الصحيح | محرك بحث الأحاديث النبوية والتأكد من صحتها'); ?>
<?php $__env->startSection('meta_description', 'ابحث الآن في أضخم موسوعة للحديث الصحيح. محرك بحث متقدم يتيح لك التأكد من صحة أي حديث شريف، مع التخريج والشرح وتراجم الرواة من مصادر موثوقة.'); ?>
